            ...
            {CERTIFICATES.map((c) => (
              <li key={c.id}>
                <Link
                  ...
                  className="border-border group block border-b transition-colors duration-150 ease-out motion-reduce:transition-none last:border-b-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500/40 focus-visible:ring-offset-2"
                  onClick={() =>
                    posthog.capture(
                      "certificate_link_clicked",
                      {
                  ...
                  <Card className="group-hover:bg-neutral-400/10 dark:group-hover:bg-neutral-600/10">
                    ...
                    <CardContent>
                      <CardHeader>
                        ...
                        <ArrowUpRightIcon
                          aria-hidden="true"
                          className="size-5 translate-x-2 text-neutral-600 transition-[rotate,color] duration-300 ease-in-out motion-reduce:transition-none group-hover:rotate-45 group-hover:text-neutral-800 dark:text-neutral-400 dark:group-hover:text-neutral-300"
                        />
                      </CardHeader>
