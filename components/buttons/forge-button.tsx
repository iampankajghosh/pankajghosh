...
const buttonVariants = cva(
  "group/button relative inline-flex shrink-0 items-center justify-center overflow-hidden whitespace-nowrap rounded-2xl border border-transparent bg-clip-padding font-geist text-sm font-medium outline-none select-none [corner-shape:squircle] will-change-transform transition-[transform,opacity,background-color,color,border-color,box-shadow,filter] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none motion-reduce:transform-none focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 active:scale-[0.97] active:duration-75 active:ease-out [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 before:absolute before:inset-0.5 before:-z-10 before:rounded-2xl before:content-[''] before:[corner-shape:squircle] after:absolute after:inset-0 after:-z-20 after:m-px after:rounded-2xl after:content-[''] after:[corner-shape:squircle] cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-neutral-800 text-white ring-1 ring-neutral-300 before:bg-transparent before:inset-shadow-2xs before:inset-shadow-neutral-400 after:bg-neutral-700 after:inset-shadow-sm after:inset-shadow-neutral-900 after:filter-[blur(0.4px)] hover:brightness-[1.03] dark:ring-neutral-800",
        outline:
